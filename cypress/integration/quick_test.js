...
describe('payment plugin quick test', () => {
    /**
    ...
    /**
     * Modify payment capture mode
     */
    it('modify plugin settings for capture mode', () => {
        TestMethods.changePluginCaptureMode(captureMode);
    });
