...
/**
 * Class MobilePayLogsActions
 */
class MobilePayLogsActions extends Field
{

  const VENDOR_NAME = 'lunarmobilepay';
  protected $_template = 'Lunar_Payment::system/config/MobilePayLogsActions.phtml';
