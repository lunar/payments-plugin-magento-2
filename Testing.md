...
* You need to have **this** module installed and configured (**test keys** required)
...
```json
{
    ...
    "ENV_ADMIN_PASS": "",
    "REMOTE_LOG_URL": "", // if you want to send log information about framework/shop & this module versions
